...
class FictionCrawlSpider(RedisSpider):
    ...
    def parse(self, response):
        ...
        for book_node in book_nodes:
            ...
            fiction_name = book_node.xpath("./div[@class='info fl']/h3//text()").extract()[0]
            ...
            yield scrapy.Request(url=fiction_chapter_url, meta={"fiction_id": fiction_id, "fiction_name": fiction_name},
    ...
    def parse_fiction_details(self, response):
        ...
        fiction_details_item_loader.add_xpath("fiction_name", "//div[@class='sitepath']/a[3]/text()")
    ...
    def parse_chapter_url(self, response):
        ...
        for url in urls:
            ...
            yield scrapy.Request(url=chapter_url, meta={"fiction_id": response.meta.get("fiction_id"),
                                                        "fiction_name": response.meta.get("fiction_name")},
    ...
    def parse_chapter_content(self, response):
        ...
        fiction_content_item_loader.add_value("fiction_name", [response.meta.get("fiction_name")])
